...
def main():
    ...
    st.write("<p style='font-size: 40px'>GENESIZ'S AI</p>",unsafe_allow_html=True)
    st.write("---")
    st.write("<p style='font-size: 35px'>Hi, This is Dinesh From AI</p>",unsafe_allow_html=True)
    st.write("###")
